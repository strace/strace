...
Output format:\n\
  ...
  -e namespace=switchTo, --namespace=switchTo\n\
                 print namespace IDs the tracee switched to just after returning\n\
                 from namespace related system calls (unshare, setns, and clone)\n\
...
init(int argc, char *argv[])
{
	...
	static const char namespace_qual[] = "switchTo";
