...
enum dump_kvm_run_structure_modes dump_kvm_run_structure;
...

{
	...
	if (dump_kvm_run_structure > DUMP_KVM_RUN_STRUCTURE_EXIT_REASON)
...
void
kvm_run_structure_decoder_init(enum dump_kvm_run_structure_modes mode)
{
	dump_kvm_run_structure = mode;
	mmap_cache_enable();
}
